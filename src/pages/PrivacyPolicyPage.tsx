    ...
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-4xl mx-auto prose prose-lg max-w-none">
        ...
        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          欢迎您使用 ZhiXue Lite！ZhiXue Lite
          是一款旨在为您提供更美观、便捷的方式来获取和展示您在智学网上的考试成绩数据的应用程序。我们深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。
        </p>
        ...
        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          个人信息是指以电子或者其他方式记录的能够单独或者与其他信息结合识别特定自然人身份或者反映特定自然人活动情况的各种信息。ZhiXue
          Lite 会出于本政策所述的以下目的，收集和使用您的个人信息：
        </p>
        ...
        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          <strong>智学网账户信息：</strong>当您使用 ZhiXue Lite
          时，我们需要您提供您的智学网账户信息（包括用户名、密码，以及可能的学生姓名和准考证号）以便于我们从智学网获取您的考试成绩数据。您的凭据将仅用于登录智学网获取数据和验证身份。
        </p>
        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          <strong>成绩数据：</strong>
          我们的核心功能是为您展示您的考试成绩，因此我们会通过智学网的接口获取您的考试成绩、试卷分析、原始答题卡等相关数据。这些数据将仅用于在应用内向您展示。
        </p>
        ...
        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          为了改善我们的产品并为您提供更好的服务，我们会使用一些第三方分析工具来收集您在使用
          ZhiXue Lite
          过程中的一些信息。这些信息是匿名的，无法与您的个人身份信息直接关联。我们使用的第三方服务包括：
        </p>
        <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 dark:text-gray-300">
          <li>
            <strong>Google Analytics：</strong>我们可能使用 Google Analytics
            来了解我们的用户是如何使用 ZhiXue Lite 的。Google Analytics
            会收集您的设备信息、浏览器类型、操作系统、IP
            地址以及您在应用内的操作行为（例如点击了哪些按钮、访问了哪些页面）。
            Google 会利用这些信息来提升用户体验和改善服务质量。
          </li>
          <li>
            <strong>Microsoft Clarity：</strong>我们可能使用 Microsoft Clarity
            来更好地理解用户需求，并通过会话重放和热图等功能来优化和改进我们的产品。Clarity
            会自动检测并遮盖可能包含个人身份信息 (PII) 的数据，以保护您的隐私。
          </li>
          <li>
            <strong>Umami：</strong>Umami
            是一款注重隐私的开源网站分析工具。它默认不使用 Cookie，并且会对 IP
            地址进行匿名化处理，以保护访客的隐私。 我们可能使用 Umami
            来统计网站的总体使用情况。
          </li>
        </ul>
        ...
        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          <strong>Google AdSense：</strong>为了维持 ZhiXue Lite
          的运营，我们可能会使用 Google AdSense 来展示广告。Google AdSense
          会使用 Cookie 等技术来收集您的信息，以便向您展示更具相关性的广告。
          Google 会遵照其隐私权政策来使用通过个性化广告收集的用户信息。
        </p>
        ...
        <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 dark:text-gray-300">
          ...
          <li>
            ...
            仅为实现本政策中声明的目的，我们的某些服务将由授权合作伙伴提供。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息。我们的合作伙伴无权将共享的个人信息用于任何其他用途。
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2 mb-6 text-gray-700 dark:text-gray-300">
          ...
          <li>
            <strong>个人信息主体注销账户：</strong>您随时可注销此前注册的账户。
          </li>
          <li>
            <strong>个人信息主体获取个人信息副本：</strong>
            您有权获取您的个人信息副本。
          </li>
          <li>
        ...
        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          未满 18
          周岁的未成年人需要在父母或其他监护人共同阅读并同意后，方可使用我们的产品、网站和服务。
        </p>
        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
